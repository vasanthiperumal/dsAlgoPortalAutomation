...
Feature: Array
 ...
 Scenario: User validates Array Page
    Given The user is in Ninja home page Array "https://dsportalapp.herokuapp.com/home"
  ...
  Scenario Outline:  User validates Max Consecutive Ones page
    ...
    When user clear the text and enter the Python code in Max Consecutive Ones page <PythonCode>
  ...
  Scenario Outline: User validate Even Number page
    ...
    When user clear the text and enter the Python code in Even Number Assessment page <PythonCode>
  ...
  Scenario Outline: User validate Sorted Array page
    ...
    When user clear the text and enter the Python code in Sorted Array Assessment page <PythonCode>
